...
from .views import (ListAllProgramView as list_all_program_view, FilterProgramView as filter_program_view, CreateProgramView as create_program,
                    ...
                    UpdateCurrentProgramView as update_current_program, DeleteCurrentProgram as delete_current_program
                    )
...
urlpatterns = [
    ...
    path("get-current-program/<str:user_id>/", get_current_program.as_view(),
         name="get-current-program"),
    path("update-current-program/<str:current_program_id>/", update_current_program.as_view(),
         name="update-current-program"),
    path("delete-current-program/<str:current_program_id>/", delete_current_program.as_view(),
         name="delete-current-program"),
]
